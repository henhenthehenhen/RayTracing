...
class lambertian: public material {
    public:
        ...
        virtual bool scatter (const ray& r_in, const hit_record& rec, color& attenuation, ray& scattered) const override {
            ...
            if (scatter_direction.near_zero()) scatter_direction = rec.normal; //can't be zero or infinite loop
...
class dielectric: public material {
    public:
        ...
        virtual bool scatter (const ray& r_in, const hit_record& rec, color& attenuation, ray& scattered) const override {
            attenuation = color (1.0, 1.0, 1.0); //doesn't absorb
    ...
    private:
        static double reflectance (double cosine, double ref_idx){ //schlick's approxmiation 
